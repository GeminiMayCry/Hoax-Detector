...
# 2. Load Model
# ======================================================
MODEL_PATH = "./indobert-hoax-classifier-tuned"
...
# Kamu bisa ganti file GIF ini sesuai file di folder kamu
gif_hoax = load_gif("./hoax.gif")          # animasi lucu hoax
gif_nonhoax = load_gif("./nonhoax.gif")    # animasi lucu fakta
...
with st.container():
    st.markdown("<div class='box'>Masukkan caption yang ingin diuji:</div>", unsafe_allow_html=True)
...
>>>>>>> 24ef92dbf6318c2e9f393c9fbe086a1c2072d819
